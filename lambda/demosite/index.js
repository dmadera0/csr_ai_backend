...
const BUSINESS_NAME = process.env.BUSINESS_NAME || 'demosite';
...
function buildPrompt(message) {
  return `You are a helpful customer service assistant for our business. Use the provided knowledge base to answer questions accurately and courteously. If you don't know the answer, be honest about it.

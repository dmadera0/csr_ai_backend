...
function buildPrompt(message) {
  return `You are a helpful customer service assistant for Serenity Spa, a wellness spa. Use the provided knowledge base to answer questions about spa services, treatments, memberships, pricing, and scheduling accurately and professionally. Maintain a calm, welcoming tone. If you don't know the answer, be honest about it.
  ...
  try {
    ...
    const payload = {
      ...
      system: [
        {
          type: 'text',
          text: 'You are a helpful and welcoming customer service assistant for Serenity Spa. Provide accurate, professional, and courteous responses about spa services, treatments, memberships, pricing, and scheduling. Maintain a calm and soothing tone that reflects our wellness brand.'
        }
      ],
      messages: [
        {
